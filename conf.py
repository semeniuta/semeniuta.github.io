...
BLOG_AUTHOR = "Oleksandr Semeniuta"  # (translatable)
BLOG_TITLE = "Oleksandr Semeniuta"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://alexsm.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://alexsm.com/"
BLOG_EMAIL = "oleksandr.semeniuta@gmail.com"
BLOG_DESCRIPTION = "Oleksandr's home on the web"  # (translatable)
